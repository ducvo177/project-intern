                            ...
                            <div class="col-lg-8">
                                <div class="p-5">
                                    <div class="d-flex justify-content-between align-items-center mb-5">
                                        ...
                                        <div class="pt-5">
                                           <a href="{{ route('delete-all') }}" class="text-body"> <button type="button" class="btn btn-danger"
                                                >Delete All</button></a>
                                        </div>
                                    </div>
                                    ...
                                    @foreach (session()->get('cart') as $cartItem)
                                        <div class="row mb-4 d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="col-md-1 col-lg-1 col-xl-1 text-end">
                                                <a href="{{ route('delete-from-cart',['id' => $cartItem['id']]) }}" class="text-muted"><i class="fas fa-times"></i></a>
                                            </div>
                                        </div>
